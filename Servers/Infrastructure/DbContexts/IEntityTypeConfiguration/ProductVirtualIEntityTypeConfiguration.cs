...
{
    public class ProductVirtualIEntityTypeConfiguration : IEntityTypeConfiguration<ProductVirtual>
    {
        public void Configure(EntityTypeBuilder<ProductVirtual> builder)
        {
            var count = 0;
